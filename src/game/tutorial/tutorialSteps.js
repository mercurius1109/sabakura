const tutorialSequence = [
  ...
  villagerCountStep(2),
  stationAssignmentStep("workbench", 1),
  stationCraftEntryStep("workbench", "plank"),
  buildStructureStep("storage"),
  completeStructureStep("storage"),
  stockRuleStep("wood"),
  buildStructureStep("cookingStation"),
  completeStructureStep("cookingStation"),
  stationAssignmentStep("cookingStation", 1),
  stationCraftEntryStep("cookingStation", "berryJam"),
